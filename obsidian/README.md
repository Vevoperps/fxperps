...
- [[home-hero]] — the home page's UI, ported from Figma, and how its pixels became a layout
- [[chess-scene]] — the home page's WebGL scene, its physics, and why it is not R3F
