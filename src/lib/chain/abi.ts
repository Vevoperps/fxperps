...
export const PERP_ENGINE_ABI = [
  ...
  "function markets(bytes32) view returns (uint32 maxLeverage, uint128 skewScale, uint128 maxOpenInterest, uint128 minMargin, uint128 longOpenInterest, uint128 shortOpenInterest, int256 fundingLong, int256 fundingShort, uint64 lastAccrual, bool listed, bool paused)",
  "function marketsView(bytes32[] ids) view returns ((bytes32 id, uint32 maxLeverage, uint128 longOpenInterest, uint128 shortOpenInterest, uint256 markPrice, int256 fundingRate, bool listed, bool paused, bool priced)[] out)",
